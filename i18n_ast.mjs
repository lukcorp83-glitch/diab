...
project.addSourceFilesAtPaths(["src/components/Profile.tsx", "src/components/Dashboard.tsx", "src/components/MiniDashboard.tsx", "src/App.tsx"]);
    ...
    sourceFile.forEachDescendant((node) => {
        ...
        if (Node.isStringLiteral(node) && node.getParentIfKind(SyntaxKind.PropertyAssignment)) {
            ...
            if (polishRegex.test(text)) {
                ...
                if (["label", "name", "desc", "sub", "title"].includes(propName)) {
