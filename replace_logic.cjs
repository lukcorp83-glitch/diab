...
const target = `                      let updatedInv = currentInv;
                      if (setIndex !== -1) {
...
const replacement = `                      const alsoReplaceReservoir = window.confirm(i18n.t('auto.czy_wymieniasz_rowniez_zbiornicze', { defaultValue: "Czy wymieniasz również zbiorniczek na insulinę?" }));
