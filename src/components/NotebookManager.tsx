...
import { collection, addDoc, deleteDoc, doc, updateDoc, serverTimestamp, query, orderBy, limit } from 'firebase/firestore';
...
export default function NotebookManager({ }: { user: any }) {
  const user = useAuthStore(state => state.user);

 const { t } = useTranslation();
 const [isOpen, setIsOpen] = useState(false);
 const { data: notes = [] } = useNotebooks(user);
